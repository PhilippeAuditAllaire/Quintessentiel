    ...
    getProductCatalogue() {
        ...
        return products.then(function(val) {
            ...
            val.forEach(function(product) {
                ...
                ele += '<a href="#" class="product-cart" onclick="event.stopPropagation();addProductToCart('+product.product_id+',1);loadCartItem().then(function(){displayCartItems()})"><img class="catalogue-produit-image-panier" src="./images/icons/cart_black.png" alt="Panier"></a>';
                ele += '</div>';
